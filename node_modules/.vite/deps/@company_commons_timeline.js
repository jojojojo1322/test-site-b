...
// node_modules/@company/commons/dist/chunk-BRG2ZZMS.js
var import_react2 = __toESM(require_react(), 1);

// node_modules/@company/commons/node_modules/react-calendar-timeline/dist/react-calendar-timeline.es.js
...
function Hn(a) {
  let i = 0, s = 0, u = true;
  for (; a; )
    !a.offsetParent && a.tagName === "BODY" && a.scrollLeft === 0 && a.scrollTop === 0 && (a = document.scrollingElement || a), i += a.offsetLeft - (u ? 0 : a.scrollLeft) + a.clientLeft, s += a.offsetTop - (u ? 0 : a.scrollTop) + a.clientTop, a = a.offsetParent, u = false;
  return { x: i, y: s };
}
function Ot(a) {
  if (a === document.body)
  ...
  (function(s, u) {
    ...
    function u(t) {
      for (var e = 1; e < arguments.length; e++) {
        ...
        e % 2 ? s(Object(r), true).forEach(function(n) {
          S(t, n, r[n]);
    ...
    function m(t, e) {
      for (var r = 0; r < e.length; r++) {
        var n = e[r];
        n.enumerable = n.enumerable || false, n.configurable = true, "value" in n && (n.writable = true), Object.defineProperty(t, O(n.key), n);
      }
    }
    function y(t, e, r) {
    ...
    function S(t, e, r) {
      return (e = O(e)) in t ? Object.defineProperty(t, e, { value: r, enumerable: true, configurable: true, writable: true }) : t[e] = r, t;
    }
    function C(t, e) {
      if (typeof e != "function" && e !== null) throw new TypeError("Super expression must either be null or a function");
      t.prototype = Object.create(e && e.prototype, { constructor: { value: t, writable: true, configurable: true } }), Object.defineProperty(t, "prototype", { writable: false }), e && R(t, e);
    }
    function D(t) {
    ...
    var nt = { id: "actions/drag", install: function(t) {
      ...
      return w.object(t) ? (this.options.drag.enabled = t.enabled !== false, this.setPerAction("drag", t), this.setOnEvents("drag", t), /^(xy|x|y|start)$/.test(t.lockAxis) && (this.options.drag.lockAxis = t.lockAxis), /^(xy|x|y)$/.test(t.startAxis) && (this.options.drag.startAxis = t.startAxis), this) : w.bool(t) ? (this.options.drag.enabled = t, this) : this.options.drag;
    ...
    function Kr(t) {
      return !!w.string(t) && (Q.document.querySelector(t), true);
    }
    function W(t, e) {
    ...
    var ct = function() {
      function t(e) {
        f(this, t), this.immediatePropagationStopped = false, this.propagationStopped = false, this._interaction = e;
      }
    ...
    var tn = function(t, e) {
      ...
      function r(n, o, l) {
        var c;
        f(this, r), (c = e.call(this, o._interaction)).dropzone = void 0, c.dragEvent = void 0, c.relatedTarget = void 0, c.draggable = void 0, c.propagationStopped = false, c.immediatePropagationStopped = false;
    ...
    var an = { id: "actions/drop", install: function(t) {
      ...
      }, W(e.phaselessTypes, { dragenter: true, dragleave: true, dropactivate: true, dropdeactivate: true, dropmove: true, drop: true }), e.methodDict.drop = "dropzone", t.dynamicDrop = false, o.actions.drop = an.defaults;
    ...
    }, defaults: { enabled: false, accept: null, overlap: "pointer" } }, lo = an;
    function Jt(t) {
    ...
    var Qt = { id: "actions/gesture", before: ["actions/drag", "actions/resize"], install: function(t) {
      ...
      r.prototype.gesturable = function(o) {
        return w.object(o) ? (this.options.gesture.enabled = o.enabled !== false, this.setPerAction("gesture", o), this.setOnEvents("gesture", o), this) : w.bool(o) ? (this.options.gesture.enabled = o, this) : this.options.gesture;
    ...
    } }, U = { defaults: { enabled: false, margin: 60, container: null, speed: 300 }, now: Date.now, interaction: null, i: 0, x: 0, y: 0, isScrolling: false, prevTime: 0, margin: 0, speed: 0, start: function(t) {
      U.isScrolling = true, be.cancel(U.i), t.autoScroll = U, U.interaction = t, U.prevTime = U.now(), U.i = be.request(U.scroll);
    }, stop: function() {
      U.isScrolling = false, U.interaction && (U.interaction.autoScroll = null), be.cancel(U.i);
    }, scroll: function() {
    ...
    var fo = { id: "auto-scroll", install: function(t) {
      ...
      t.autoScroll = U, U.now = function() {
        return t.now();
      }, r.phaselessTypes.autoscroll = true, e.perAction.autoScroll = U.defaults;
    }, listeners: { "interactions:new": function(t) {
    ...
    function Be(t, e) {
      var r = false;
      return function() {
        return r || (H.console.warn(e), r = true), t.apply(this, arguments);
      };
    }
    function er(t, e) {
    ...
    var To = { id: "auto-start/base", before: ["actions"], install: function(t) {
      ...
      t.usePlugin(bo), r.base.actionChecker = null, r.base.styleCursor = true, W(r.perAction, { manualStart: false, max: 1 / 0, maxPerElement: 1, allowFrom: null, ignoreFrom: null, mouseButtons: 1 }), e.maxInteractions = function(n) {
        return vn(n, t);
    ...
    var ir = function() {
      function t(e) {
        f(this, t), this.states = [], this.startOffset = { left: 0, right: 0, top: 0, bottom: 0 }, this.startDelta = void 0, this.result = void 0, this.endResult = void 0, this.startEdges = void 0, this.edges = void 0, this.interaction = void 0, this.interaction = e, this.result = ht(), this.edges = { left: false, right: false, top: false, bottom: false };
      }
    ...
    } } }, bn = _o, yn = { base: { preventDefault: "auto", deltaSource: "page" }, perAction: { enabled: false, origin: { x: 0, y: 0 } }, actions: {} }, or = function(t) {
      C(r, t);
      var e = P(r);
    ...
    var Po = y(function t(e, r, n, o, l) {
      ...
      function t(e) {
        ...
        f(this, t), this.interactable = null, this.element = null, this.rect = null, this._rects = void 0, this.edges = null, this._scopeFire = void 0, this.prepared = { name: null, axis: null, edges: null }, this.pointerType = void 0, this.pointers = [], this.downEvent = null, this.downPointer = {}, this._latestPointer = { pointer: null, event: null, eventTarget: null }, this.prevEvent = null, this.pointerIsDown = false, this.pointerWasMoved = false, this._interacting = false, this._ending = false, this._stopped = true, this._proxy = void 0, this.simulation = null, this.doMove = Be(function(d) {
          this.move(d);
      ...
      return y(t, [{ key: "pointerMoveTolerance", get: function() {
        ...
        return !(this.interacting() || !this.pointerIsDown || this.pointers.length < (e.name === "gesture" ? 2 : 1) || !r.options[e.name].enabled) && (er(this.prepared, e), this.interactable = r, this.element = n, this.rect = r.getRect(n), this.edges = this.prepared.edges ? W({}, this.prepared.edges) : { left: true, right: true, top: true, bottom: true }, this._stopped = false, this._interacting = this._doPhase({ interaction: this, event: this.downEvent, phase: "start" }) && !this._stopped, this._interacting);
        ...
        return o = o !== false && (o || /(down|start)$/i.test(r.type)), d ? d.pointer = e : (d = new Po(h, e, r, null, null), g = this.pointers.length, this.pointers.push(d)), ao(this.coords.cur, this.pointers.map(function(b) {
          return b.pointer;
        ...
        if (c && n === "move" && (ot(this.edges, c, this.coords.delta[this.interactable.options.deltaSource]), c.width = c.right - c.left, c.height = c.bottom - c.top), this._scopeFire("interactions:before-action-".concat(n), e) === false) return false;
    ...
    function xn(t) {
      ...
      return sr(t.coords.cur, e), sr(t.coords.delta, e), ot(t.edges, t.rect, e), e.x = 0, e.y = 0, true;
    }
    function Do(t) {
      var e = t.x, r = t.y;
    ...
    var ko = { id: "offset", before: ["modifiers", "pointer-events", "actions", "inertia"], install: function(t) {
      ...
      return y(t, [{ key: "start", value: function(e) {
        ...
        l.offsetBy({ x: -this.currentOffset.x, y: -this.currentOffset.y }), l.updatePointer(r, n, o, true), l._doPhase({ interaction: l, event: n, phase: "resume" }), at(l.coords.prev, l.coords.cur), this.stop();
      } }, { key: "end", value: function() {
        this.interaction.move(), this.interaction.end(), this.stop();
      } }, { key: "stop", value: function() {
        this.active = this.smoothEnd = false, this.interaction.simulation = null, be.cancel(this.timeout);
      } }]), t;
    }();
    function dt(t) {
    ...
    var $o = { id: "inertia", before: ["modifiers", "actions"], install: function(t) {
      var e = t.defaults;
      t.usePlugin(Sn), t.usePlugin(bn), t.actions.phases.inertiastart = true, t.actions.phases.resume = true, e.perAction.inertia = { enabled: false, resistance: 10, minSpeed: 100, endSpeed: 10, allowResume: true, smoothEndDuration: 300 };
    }, listeners: { "interactions:new": function(t) {
      var e = t.interaction;
      e.inertia = new zo(e);
    }, "interactions:before-action-end": function(t) {
    ...
    var _n = function() {
      function t(e) {
        f(this, t), this.options = void 0, this.types = {}, this.propagationStopped = false, this.immediatePropagationStopped = false, this.global = void 0, this.options = W({}, e || {});
      }
    ...
    function qe(t) {
      return w.object(t) ? { capture: !!t.capture, passive: !!t.passive } : { capture: !!t, passive: false };
    }
    function ft(t, e) {
            ...
            if (N.selector === d && N.context === b) {
              for (var K = N.listeners, F = K.length - 1; F >= 0; F--) {
                ...
                if (G.func === I && ft(G.options, $)) {
                  K.splice(F, 1), K.length || (z.splice(M, 1), p(b, x, h), p(b, x, g, true)), A = true;
                  break;
                }
              }
              if (A) break;
            ...
            if (z) {
              ...
              for (var K = qe(I), F = 0; F < z.length; F++) {
                ...
                if (G.func === x && ft(G.options, K)) {
                  d.removeEventListener(b, x, l.supportsOptions ? K : K.capture), z.splice(F, 1), z.length === 0 && (delete M.events[b], $ = true);
                  break;
                }
              }
            }
    ...
    var Wo = { id: "core/interactions", install: function(t) {
      ...
      return y(t, [{ key: "_defaults", get: function() {
        ...
        for (var o in r) {
          ...
          l === "listeners" && this.updatePerActionListeners(e, c.listeners, p), w.array(p) ? c[l] = rn(p) : w.plainObject(p) ? (c[l] = W(c[l] || {}, ke(p)), w.object(n.perAction[l]) && "enabled" in n.perAction[l] && (c[l].enabled = p.enabled !== false)) : w.bool(p) && w.object(n.perAction[l]) ? c[l].enabled = p : c[l] = p;
        }
      } }, { key: "getRect", value: function(e) {
      ...
      return y(t, [{ key: "new", value: function(e, r) {
        ...
        return this.scope.addDocument(n._doc), this.list.push(n), w.string(e) ? (this.selectorMap[e] || (this.selectorMap[e] = []), this.selectorMap[e].push(n)) : (n.target[this.scope.id] || Object.defineProperty(e, this.scope.id, { value: [], configurable: true }), e[this.scope.id].push(n)), this.scope.fire("interactable:new", { target: e, options: r, interactable: n, win: this.scope._win }), n;
      ...
      function t() {
        var e = this;
        f(this, t), this.id = "__interact_scope_".concat(Math.floor(100 * Math.random())), this.isInitialized = false, this.listenerMaps = [], this.browser = oe, this.defaults = ke(yn), this.Eventable = _n, this.actions = { map: {}, phases: { start: true, move: true, end: true }, methodDict: {}, phaselessTypes: {} }, this.interactStatic = function(n) {
      ...
      return y(t, [{ key: "addListeners", value: function(e, r) {
        ...
        return this.isInitialized ? this : function(r, n) {
          return r.isInitialized = true, w.window(n) && X(n), Q.init(n), oe.init(n), be.init(n), r.window = n, r.document = n.document, r.usePlugin(Fo), r.usePlugin(Lo), r;
        }(this, e);
    ...
    var Ko = Object.freeze({ __proto__: null, edgeTarget: function() {
      ...
      if (p !== false && W(n, b), d != null && d.length) {
    ...
    }, defaults: { restriction: null, elementRect: null, offset: null, endOnly: false, enabled: false } }, Qo = ye(gt, "restrict"), zn = { top: 1 / 0, left: 1 / 0, bottom: -1 / 0, right: -1 / 0 }, $n = { top: -1 / 0, left: -1 / 0, bottom: 1 / 0, right: 1 / 0 };
    function jn(t, e) {
    ...
    var Ze = { noInner: zn, noOuter: $n, start: function(t) {
    ...
    }, defaults: { inner: null, outer: null, offset: null, endOnly: false, enabled: false } }, es = ye(Ze, "restrictEdges"), ts = W({ get elementRect() {
    ...
    }, defaults: { min: null, max: null, endOnly: false, enabled: false } }, "restrictSize"), ur = { start: function(t) {
      ...
      for (var A = { target: null, inRange: false, distance: 0, range: 0, delta: { x: 0, y: 0 } }, N = 0; N < h.length; N++) {
        var K = h[N], F = K.range, G = K.x - p.x, te = K.y - p.y, J = Ge(G, te), re = J <= F;
        F === 1 / 0 && A.inRange && A.range !== 1 / 0 && (re = false), A.target && !(re ? A.inRange && F !== 1 / 0 ? J / F < A.distance / A.range : F === 1 / 0 && A.range !== 1 / 0 || J < A.distance : !A.inRange && J < A.distance) || (A.target = K, A.distance = J, A.range = F, A.inRange = re, A.delta.x = G, A.delta.y = te);
      }
      return A.inRange && (r.x = A.target.x, r.y = A.target.y), n.closest = A, A;
    }, defaults: { range: 1 / 0, targets: null, offset: null, offsetWithOrigin: true, origin: null, relativePoints: null, endOnly: false, enabled: false } }, ss = ye(ur, "snap"), mt = { start: function(t) {
      ...
      var $ = ur.set(t);
      return r.options = o, $;
    }, defaults: { range: 1 / 0, targets: null, offset: null, endOnly: false, enabled: false } }, as = ye(mt, "snapSize"), pr = { aspectRatio: Jo, restrictEdges: es, restrict: Qo, restrictRect: rs, restrictSize: os, snapEdges: ye({ start: function(t) {
      var e = t.edges;
      ...
      hr(t), we(t, e);
    } }, PointerEvent: An, fire: we, collectEventTargets: Ln, defaults: { holdDuration: 600, ignoreFrom: null, allowFrom: null, origin: { x: 0, y: 0 } }, types: { down: true, move: true, up: true, cancel: true, tap: true, doubletap: true, hold: true } };
    function we(t, e) {
          ...
          for (var c = n.getAllElements(), p = l.window.Promise, h = p ? [] : null, g = function() {
            ...
            if (E) E.move(), h && (I = E._reflowPromise || new p(function(z) {
              ...
              I = function(z, A, N, K, F) {
                ...
                G.interactable = A, G.element = N, G.prevEvent = F, G.updatePointer(F, F, N, true), Vr(G.coords.delta), er(G.prepared, K), G._doPhase(te);
...
(function(a, i) {
  (function(s, u) {
    ...
    return function(f, m, y) {
      var S = m.prototype;
      y.utc = function(O) {
        var k = { date: O, utc: true, args: arguments };
        return new m(k);
      }, S.utc = function(O) {
      ...
      var C = S.parse;
      S.parse = function(O) {
        O.utc && (this.$u = true), this.$utils().u(O.$offset) || (this.$offset = O.$offset), C.call(this, O);
      };
      var D = S.init;
      S.init = function() {
        if (this.$u) {
      ...
      S.utcOffset = function(O, k) {
        ...
        var X = this.clone();
        if (k) return X.$offset = H, X.$u = false, X;
...
function Ds(a) {
  ...
  if (s < 0)
    return false;
  var u = i.length - 1;
  return s == u ? i.pop() : Rs.call(i, s, 1), --this.size, true;
}
var ks = Ds;
var zs = Dt;
function $s(a) {
...
var ra = ta;
var na = typeof Ie == "object" && Ie && Ie.Object === Object && Ie;
var Ci = na;
var ia = Ci;
var oa = typeof self == "object" && self && self.Object === Object && self;
var sa = ia || oa || Function("return this")();
var ge = sa;
var aa = ge;
var la = aa.Symbol;
var _r = la;
...
var ca = Ei.hasOwnProperty;
var ua = Ei.toString;
var et = Wn ? Wn.toStringTag : void 0;
function pa(a) {
...
var _a = "[object GeneratorFunction]";
var Pa = "[object Proxy]";
function Ia(a) {
  if (!Oa(a))
    return false;
...
function zc(a, i, s, u, v, f) {
  ...
  if (C && D)
    return C == i && D == a;
  var R = -1, T = true, P = s & kc ? new Ic() : void 0;
...
var qc = "[object Error]";
var Zc = "[object Map]";
var Jc = "[object Number]";
var Qc = "[object RegExp]";
var eu = "[object Set]";
var tu = "[object String]";
var ru = "[object Symbol]";
var nu = "[object ArrayBuffer]";
var iu = "[object DataView]";
var Bn = Kn ? Kn.prototype : void 0;
var vr = Bn ? Bn.valueOf : void 0;
...
var wu = Tu.propertyIsEnumerable;
var Vn = Object.getOwnPropertySymbols;
var xu = Vn ? function(a) {
...
var ku = Di.hasOwnProperty;
var zu = Di.propertyIsEnumerable;
var $u = qn(/* @__PURE__ */ function() {
  return arguments;
}()) ? qn : function(a) {
...
Pt.exports;
(function(a, i) {
  var s = ge, u = Lu, v = i && !i.nodeType && i, f = v && true && a && !a.nodeType && a, m = f && f.exports === v, y = m ? s.Buffer : void 0, S = y ? y.isBuffer : void 0, C = S || u;
  a.exports = C;
})(Pt, Pt.exports);
var ki = Pt.exports;
...
var Vu = "[object Array]";
var qu = "[object Boolean]";
var Zu = "[object Date]";
var Ju = "[object Error]";
var Qu = "[object Function]";
var ep = "[object Map]";
var tp = "[object Number]";
var rp = "[object Object]";
var np = "[object RegExp]";
var ip = "[object Set]";
var op = "[object String]";
var sp = "[object WeakMap]";
var ap = "[object ArrayBuffer]";
var lp = "[object DataView]";
var cp = "[object Float32Array]";
var up = "[object Float64Array]";
var pp = "[object Int8Array]";
var hp = "[object Int16Array]";
var dp = "[object Int32Array]";
var fp = "[object Uint8Array]";
var vp = "[object Uint8ClampedArray]";
var gp = "[object Uint16Array]";
var mp = "[object Uint32Array]";
var q = {};
q[cp] = q[up] = q[pp] = q[hp] = q[dp] = q[fp] = q[vp] = q[gp] = q[mp] = true;
q[Bu] = q[Vu] = q[ap] = q[qu] = q[lp] = q[Zu] = q[Ju] = q[Qu] = q[ep] = q[tp] = q[rp] = q[np] = q[ip] = q[op] = q[sp] = false;
function bp(a) {
...
It.exports;
(function(a, i) {
  var s = Ci, u = i && !i.nodeType && i, v = u && true && a && !a.nodeType && a, f = v && v.exports === u, m = f && s.process, y = function() {
    try {
...
var Wp = Hp;
var Fp = Wp;
var Up = Fp(Object.keys, Object);
var Np = Up;
var Gp = Lp;
var Yp = Np;
var Kp = Object.prototype;
var Xp = Kp.hasOwnProperty;
function Bp(a) {
  if (!Gp(a))
    return Yp(a);
  var i = [];
...
function dh(a, i, s, u, v, f) {
  ...
  if (O && !k) {
    ...
    B != V && "constructor" in a && "constructor" in i && !(typeof B == "function" && B instanceof B && typeof V == "function" && V instanceof V) && (O = false);
  }
...
var vh = Ae;
var gh = ge;
var mh = vh(gh, "DataView");
var bh = mh;
var yh = Ae;
var Th = ge;
var wh = yh(Th, "Promise");
var xh = wh;
var Sh = Ae;
var Oh = ge;
var Ch = Sh(Oh, "Set");
...
function Gh(a, i, s, u, v, f) {
  ...
  return T ? (f || (f = new gr()), Wh(a, i, s, u, v, f)) : false;
}
var Yh = Gh;
var Kh = Yh;
var pi = At;
function Ai(a, i, s, u, v) {
  return a === i ? true : a == null || i == null || !pi(a) && !pi(i) ? a !== a && i !== i : Kh(a, i, s, u, Ai, v);
}
var Xh = Ai;
var Bh = Xh;
function Vh(a, i) {
...
function Rr(a, i, s, u, v) {
  let f = (0, import_dayjs.default)(a).startOf(s);
  if (u[s] && u[s] > 1) {
    const m = f.get(s);
    f = f.set(s, m - m % u[s]);
  }
  for (; f.valueOf() < i; ) {
    let m = (0, import_dayjs.default)(f).add(u[s] || 1, s).startOf(s);
...
function zr(a, i, s, u) {
  ...
  return a.filter((m) => {
    const y = (0, import_dayjs.default)(Y(m, v)).valueOf() <= s, S = (0, import_dayjs.default)(Y(m, f)).valueOf() >= i;
    return y && S;
  });
}
var Jh = 1e-3;
...
var jr = import_react.default.createContext(ld);
var { Consumer: cd, Provider: ud } = jr;
var pd = class extends import_react.default.Component {
  constructor(i) {
  ...
  render() {
    return (0, import_jsx_runtime.jsx)(ud, { value: this.state.timelineContext, children: this.props.children });
  }
};
var Lt = cd;
var hd = () => (0, import_react.useContext)(jr);
import_dayjs.default.extend(Ss);
var Ar = class extends import_react.Component {
  constructor(i) {
    super(i), Object.defineProperty(this, "state", {
      ...
      writable: true,
      value: (s) => {
        this.state.interactMounted || (s.preventDefault(), this.startedClicking = true);
      }
      ...
      writable: true,
      value: (s) => {
        !this.state.interactMounted && this.startedClicking && (this.startedClicking = false, this.actualClick(s, "click"));
      }
      ...
      writable: true,
      value: (s) => {
        this.state.interactMounted || (s.preventDefault(), this.startedTouching = true);
      }
      ...
      writable: true,
      value: (s) => {
        !this.state.interactMounted && this.startedTouching && (this.startedTouching = false, this.actualClick(s, "touch"));
      }
  ...
  dragTimeSnap(i, s) {
    ...
    if (u) {
      const v = s ? (0, import_dayjs.default)().utcOffset() * 60 * 1e3 : 0;
  ...
  dragTime(i) {
    const s = (0, import_dayjs.default)(this.itemTimeStart);
    return this.state.dragging ? this.dragTimeSnap(this.timeFor(i) + this.state.dragStart.offset, true) : s.valueOf();
  }
  timeFor(i) {
  ...
  mountInteract() {
    const i = this.props.useResizeHandle ? ".rct-item-handler-resize-left" : true, s = this.props.useResizeHandle ? ".rct-item-handler-resize-right" : true;
  ...
  componentDidUpdate(i) {
    ...
    if (this.itemRef && this.itemRef.current) {
      if (this.props.selected && !s && (this.mountInteract(), s = true), s && (v !== y || f !== S)) {
        const C = this.props.useResizeHandle ? this.dragLeft : true, D = this.props.useResizeHandle ? this.dragRight : true;
        dr(this.itemRef.current).resizable({
          enabled: y || S,
          edges: {
            top: false,
...
function fd(a, i) {
  const s = Y(a, "canResize") !== void 0 ? Y(a, "canResize") : i;
  return s === "right" || s === "both" || s === true;
}
var vd = class extends import_react.Component {
...
var fi = class extends import_react.Component {
  ...
  renderGroupContent(i, s = false, u, v) {
  ...
  render() {
    const { width: i, groupHeights: s, height: u, isRightSidebar: v } = this.props, { groupIdKey: f, groupTitleKey: m, groupRightTitleKey: y } = this.props.keys, S = {
      ...
      return (0, import_jsx_runtime.jsx)("div", { className: "rct-sidebar-row rct-sidebar-row-" + (T % 2 === 0 ? "even" : "odd"), style: P, children: this.renderGroupContent(R, v, m, y) }, Y(R, f));
    });
    return (0, import_jsx_runtime.jsx)("div", { className: "rct-sidebar" + (v ? " rct-sidebar-right" : ""), style: S, children: (0, import_jsx_runtime.jsx)("div", { style: C, children: D }) });
  }
};
var gd = class extends import_react.Component {
  shouldComponentUpdate(i) {
  ...
  render() {
    ...
    return Rr(i, s, u, v, (C, D) => {
      ...
      S.push((0, import_jsx_runtime.jsx)("div", { className: _, style: {
        pointerEvents: "none",
        top: "0px",
        left: `${O}px`,
        width: `${k - O}px`,
    ...
    }), (0, import_jsx_runtime.jsx)("div", { className: "rct-vertical-lines", children: S });
  }
};
var md = ({ ...a }) => (0, import_jsx_runtime.jsx)(Lt, { children: ({ getLeftOffsetFromDate: i }) => (0, import_jsx_runtime.jsx)(gd, { getLeftOffsetFromDate: i, ...a }) });
...
var yd = class extends import_react.Component {
  render() {
    ...
    let C = [];
    return y && (C = y(S)), (0, import_jsx_runtime.jsx)(bd, { clickTolerance: m, onClick: f, children: (0, import_jsx_runtime.jsx)("div", { onContextMenu: i, onDoubleClick: s, className: (u ? "rct-hl-even " : "rct-hl-odd ") + (C ? C.join(" ") : ""), style: v }) });
  }
};
var Td = class extends import_react.Component {
  ...
  render() {
    ...
    for (let R = 0; R < s; R++)
      D.push((0, import_jsx_runtime.jsx)(yd, { clickTolerance: m, onContextMenu: (T) => C(T, R), onClick: (T) => v(T, R), onDoubleClick: (T) => f(T, R), isEvenRow: R % 2 === 0, group: y[R], horizontalLineClassNamesForGroup: S, style: {
        width: `${i}px`,
        height: `${u[R]}px`
      } }, `horizontal-line-${R}`));
    return (0, import_jsx_runtime.jsx)("div", { className: "rct-horizontal-lines", children: D });
  }
};
var wd = class extends import_react.Component {
  ...
  render() {
    ...
    return (0, import_jsx_runtime.jsx)("div", { ref: this.scrollComponentRef, "data-testid": "scroll-element", className: "rct-scroll", style: f, onScroll: this.handleScroll, children: u });
  }
};
var xd = {
...
var { Consumer: Sd, Provider: Od } = import_react.default.createContext(xd);
var Cd = Od;
var Ed = Sd;
var _d = {
  markers: [],
...
var { Consumer: Pd, Provider: Id } = import_react.default.createContext(_d);
var vi = 0;
var Md = () => (vi += 1, vi + 1);
var Rd = class extends import_react.default.Component {
  constructor(i) {
  ...
  render() {
    return (0, import_jsx_runtime.jsx)(Id, { value: this.state, children: this.props.children });
  }
};
var Ht = Pd;
var xe;
...
var Hr = (a) => function({ styles: s }) {
  return (0, import_jsx_runtime.jsx)("div", { style: s, "data-testid": a });
};
var kd = Hr("default-today-line");
var Vi = class extends import_react.default.Component {
  constructor() {
...
var zd = Hr("default-customer-marker-id");
...
var $d = Hr("default-cursor-marker");
...
var Ji = (a) => (0, import_jsx_runtime.jsx)(Ed, { children: ({ subscribeToMouseOver: i }) => (0, import_jsx_runtime.jsx)(Zi, { subscribeToCanvasMouseOver: i, ...a }) });
Ji.displayName = "CursorMarkerWrapper";
var jd = () => (0, import_jsx_runtime.jsx)(Lt, { children: ({ getLeftOffsetFromDate: a, getTimelineState: i }) => (0, import_jsx_runtime.jsx)(Ht, { children: ({ markers: s }) => {
  const u = i();
  return s.map((v) => {
    switch (v.type) {
      case xe.Today:
        return (/* @__PURE__ */ new Date()).valueOf() >= u.canvasTimeStart && (/* @__PURE__ */ new Date()).valueOf() <= u.canvasTimeEnd ? (0, import_jsx_runtime.jsx)(Vi, { getLeftOffsetFromDate: a, renderer: v.renderer, interval: v.interval }, v.id) : null;
      case xe.Custom:
        return v.date >= u.canvasTimeStart && v.date <= u.canvasTimeEnd ? (0, import_jsx_runtime.jsx)(qi, { renderer: v.renderer, date: v.date, getLeftOffsetFromDate: a }, v.id) : null;
      case xe.Cursor:
        return (0, import_jsx_runtime.jsx)(Ji, { renderer: v.renderer, getLeftOffsetFromDate: a }, v.id);
      default:
        return null;
    }
  });
...
var Ld = class extends import_react.default.Component {
  constructor() {
  ...
  render() {
    return (0, import_jsx_runtime.jsx)(Cd, { value: this.state, children: (0, import_jsx_runtime.jsxs)("div", { style: Ad, onMouseMove: this.handleMouseMove, onMouseLeave: this.handleMouseLeave, ref: this.containerEl, children: [(0, import_jsx_runtime.jsx)(jd, {}), this.props.children] }) });
  }
};
var Hd = (a) => (0, import_jsx_runtime.jsx)(Lt, { children: ({ getDateFromLeftOffsetPosition: i }) => (0, import_jsx_runtime.jsx)(Ld, { getDateFromLeftOffsetPosition: i, ...a }) });
function Wd(a) {
...
var gi = { addListener: Wd, removeListener: Fd };
var Ud = {
  groupIdKey: "id",
  groupTitleKey: "title",
...
var Qi = import_react.default.createContext(Yd);
var Kd = class extends import_react.default.Component {
  render() {
    const i = {
    ...
    return (0, import_jsx_runtime.jsx)(Qi.Provider, { value: i, children: this.props.children });
  }
};
var Xd = Qi;
var Wr = () => (0, import_react.useContext)(Xd);
var eo = { exports: {} };
(function(a) {
  (function() {
...
var Vd = "left";
var to = "right";
var qd = class extends import_react.PureComponent {
  constructor() {
...
var Zd = ({ getRootProps: a }) => (0, import_jsx_runtime.jsx)("div", { "data-testid": "sidebarHeader", ...a() });
var St = (a) => {
  const { children: i, variant: s = Vd, headerData: u } = a, { leftSidebarWidth: v, rightSidebarWidth: f } = Wr();
  return (0, import_jsx_runtime.jsx)(qd, { leftSidebarWidth: v, rightSidebarWidth: f, variant: s, headerData: u, children: i || Zd });
};
St.secretKey = "SidebarHeader";
var Jd = class extends import_react.default.Component {
  constructor() {
    super(...arguments), Object.defineProperty(this, "getRootStyle", {
      ...
      configurable: true,
      writable: true,
      value: (i) => i.type === void 0 ? false : i.type.secretKey === St.secretKey
    });
  }
  render() {
    let i, s;
    const u = [], v = Array.isArray(this.props.children) ? this.props.children.filter((f) => f) : [this.props.children];
    return import_react.default.Children.map(v, (f) => {
      var m;
      this.isSidebarHeader(f) ? ((m = f == null ? void 0 : f.props) == null ? void 0 : m.variant) === to ? i = f : s = f : u.push(f);
    }), s || (s = (0, import_jsx_runtime.jsx)(St, {})), !i && this.props.rightSidebarWidth && (i = (0, import_jsx_runtime.jsx)(St, { variant: "right" })), (0, import_jsx_runtime.jsxs)("div", { "data-testid": "headerRootDiv", style: this.getRootStyle(), className: mi("rct-header-root", this.props.className), children: [s, (0, import_jsx_runtime.jsx)("div", { ref: this.props.registerScroll, style: this.getCalendarHeaderStyle(), className: mi("rct-calendar-header", this.props.calendarHeaderClassName), "data-testid": "headerContainer", children: u }), i] });
  }
};
var Er = ({ children: a, style: i, className: s, calendarHeaderStyle: u, calendarHeaderClassName: v }) => {
  const { leftSidebarWidth: f, rightSidebarWidth: m, registerScroll: y } = Wr();
  return (0, import_jsx_runtime.jsx)(Jd, { leftSidebarWidth: f, rightSidebarWidth: m, registerScroll: y, style: i, className: s, calendarHeaderStyle: u, calendarHeaderClassName: v, children: a });
};
Er.secretKey = "TimelineHeaders";
var ro = class extends import_react.default.Component {
  constructor(i) {
...
function Qd({ children: a, unit: i, headerData: s, height: u }) {
  ...
  return (0, import_jsx_runtime.jsx)(ro, { children: a, timeSteps: S, showPeriod: f, unit: i || y.timelineUnit, ...y, headerData: s, getLeftOffsetFromDate: m, height: u });
}
...
var rf = class extends import_react.default.PureComponent {
  constructor() {
...
function nf({ headerContext: { intervals: a, unit: i }, getRootProps: s, getIntervalProps: u, showPeriod: v, data: { style: f, intervalRenderer: m, className: y, getLabelFormat: S, unitProp: C, headerData: D } }) {
  return (0, import_jsx_runtime.jsx)("div", { "data-testid": "dateHeader", className: y, ...s({ style: f }), children: a.map((R) => {
    const T = S([R.startTime, R.endTime], i, R.labelWidth);
    return (0, import_jsx_runtime.jsx)(rf, { unit: i, interval: R, showPeriod: v, intervalText: T, primaryHeader: C === "primaryHeader", getIntervalProps: u, intervalRenderer: m, headerData: D }, `label-${R.startTime.valueOf()}`);
  }) });
}
var of = class extends import_react.default.Component {
  constructor() {
  ...
  render() {
    ...
    return (0, import_jsx_runtime.jsx)(Qd, { children: nf, unit: i, height: s, headerData: this.getHeaderData(this.props.intervalRenderer, this.getRootStyle(this.props.style), this.props.className, this.getLabelFormat, this.props.unit, this.props.headerData) });
  }
};
function Ti({ labelFormat: a, unit: i, style: s, className: u, intervalRenderer: v, headerData: f, height: m }) {
  return (0, import_jsx_runtime.jsx)(Lt, { children: ({ getTimelineState: y }) => {
    const S = y();
    return (0, import_jsx_runtime.jsx)(of, { timelineUnit: S.timelineUnit, unit: i, labelFormat: a || sf, style: s, className: u, intervalRenderer: v, headerData: f, height: m });
  } });
}
var sf = ([a], i, s = 150, u = Gd) => {
  let v;
...
var af = no.exports;
var lf = rt(af);
import_dayjs.default.extend(lf);
var io = class extends import_react.Component {
  constructor(i) {
    super(i), Object.defineProperty(this, "getTimelineContext", {
      ...
      configurable: true,
      writable: true,
      value: (T, P, _ = false, O = this.props.items, k = this.props.groups) => {
      ...
      configurable: true,
      writable: true,
      value: (T) => T.type === void 0 ? false : T.type.secretKey === Er.secretKey
      ...
      value: () => {
        if (this.props.children) {
          let T;
          if (import_react.default.Children.map(this.props.children, (P) => {
            this.isTimelineHeader(P) && (T = P);
          }), T)
            return T;
        }
        return (0, import_jsx_runtime.jsxs)(Er, { children: [(0, import_jsx_runtime.jsx)(Ti, { unit: "primaryHeader" }), (0, import_jsx_runtime.jsx)(Ti, {})] });
      }
      ...
      value: (T, P) => {
        ...
        const B = (0, import_dayjs.default)().utcOffset() * 60 * 1e3;
        return {
  ...
  childrenWithProps(i, s, u, v, f, m, y, S, C, D, R) {
    ...
    return import_react.default.Children.map(T, (_) => this.isTimelineHeader(_) ? null : import_react.default.cloneElement(_, P));
  }
  getSelected() {
  ...
  render() {
    ...
    return (0, import_jsx_runtime.jsx)(pd, { visibleTimeStart: R, visibleTimeEnd: T, canvasTimeStart: P, canvasTimeEnd: _, canvasWidth: B, showPeriod: this.showPeriod, timelineUnit: V, timelineWidth: this.state.width, children: (0, import_jsx_runtime.jsx)(Rd, { children: (0, import_jsx_runtime.jsx)(Kd, { registerScroll: this.handleHeaderRef, timeSteps: f, leftSidebarWidth: this.props.sidebarWidth, rightSidebarWidth: this.props.rightSidebarWidth, children: (0, import_jsx_runtime.jsxs)("div", { style: this.props.style, ref: this.container, className: `react-calendar-timeline ${this.props.className}`, children: [this.renderHeaders(), (0, import_jsx_runtime.jsxs)("div", { style: w, className: "rct-outer", children: [u > 0 ? this.sidebar(k, L) : null, (0, import_jsx_runtime.jsx)(wd, { scrollRef: this.getScrollElementRef, width: D, height: k, onZoom: this.changeZoom, onWheelZoom: this.handleWheelZoom, traditionalZoom: !!m, onScroll: this.onScroll, children: (0, import_jsx_runtime.jsxs)(Hd, { children: [this.columns(P, _, B, V, f, k), this.rows(B, L, s), this.items({
      canvasTimeStart: P,
      canvasTimeEnd: _,
      canvasWidth: B,
      dimensionItems: O,
...
Object.defineProperty(io, "setDayjsLocale", {
  ...
  configurable: true,
  writable: true,
  value: import_dayjs.default.locale
});
...
var oo = class extends import_react.default.Component {
  constructor() {
...
var cf = (a) => (0, import_jsx_runtime.jsx)(Ht, { children: ({ subscribeMarker: i, updateMarker: s }) => (0, import_jsx_runtime.jsx)(oo, { subscribeMarker: i, updateMarker: s, ...a }) });
cf.displayName = "TodayMarkerWrapper";
var uf = class extends import_react.Component {
  constructor() {
    super(...arguments), Object.defineProperty(this, "unsubscribe", {
      enumerable: true,
      configurable: true,
...
var pf = (a) => (0, import_jsx_runtime.jsx)(Ht, { children: ({ subscribeMarker: i, updateMarker: s }) => (0, import_jsx_runtime.jsx)(uf, { subscribeMarker: i, updateMarker: s, ...a }) });
...
var df = (a) => (0, import_jsx_runtime.jsx)(Ht, { children: ({ subscribeMarker: i }) => (0, import_jsx_runtime.jsx)(hf, { subscribeMarker: i, ...a }) });
...
var TimelineWrapper = ({
  ...
  const timeStart = (0, import_react2.useMemo)(
    () => (defaultTimeStart == null ? void 0 : defaultTimeStart.getTime()) ?? (0, import_dayjs2.default)().startOf("day").valueOf(),
    [defaultTimeStart]
  );
  const timeEnd = (0, import_react2.useMemo)(
    () => (defaultTimeEnd == null ? void 0 : defaultTimeEnd.getTime()) ?? (0, import_dayjs2.default)().endOf("day").valueOf(),
    [defaultTimeEnd]
  );
  ...
  const handleItemMove = (0, import_react2.useCallback)(
    (itemId, dragTime, newGroupOrder) => {
      onItemMove == null ? void 0 : onItemMove(itemId, dragTime, newGroupOrder);
    },
    [onItemMove]
  );
  const handleItemResize = (0, import_react2.useCallback)(
    (itemId, time, edge) => {
  ...
  return (0, import_jsx_runtime2.jsx)("div", { className, style: containerStyle, children: (0, import_jsx_runtime2.jsx)(
    io,
    {
      groups,
      items,
      ...
      children: showHeader && (0, import_jsx_runtime2.jsxs)(Er, { children: [
        (0, import_jsx_runtime2.jsx)(St, { children: ({ getRootProps }) => (0, import_jsx_runtime2.jsx)("div", { ...getRootProps(), children: headerLabel }) }),
        (0, import_jsx_runtime2.jsx)(Ti, { unit: "primaryHeader" }),
        (0, import_jsx_runtime2.jsx)(Ti, {})
      ] })
    }
  ) });
};
